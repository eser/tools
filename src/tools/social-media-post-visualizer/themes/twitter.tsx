...
function avatar(url: string | undefined, size: number) {
  ...
  return (
    <div style={{ width: size, height: size, borderRadius: "50%", background: "#2f3336", display: "flex", alignItems: "center", justifyContent: "center" }}>
      <span style={{ fontSize: Math.round(size * 0.45), color: "#71767b" }}>?</span>
    </div>
  );
}
  ...
  return (
    ...
    >
      ...
      <div style={{ display: "flex", gap: "12px" }}>
        {avatar(post.author.avatarUrl, 48)}
          ...
          {post.quotedPost !== undefined && (
            ...
            >
              <div style={{ display: "flex", gap: "8px", alignItems: "center" }}>
                {avatar(post.quotedPost.author.avatarUrl, 20)}
      ...
      {comments.length > 0 && (
        ...
        >
          {sortByTimestamp(comments).map((comment, i) => (
            ...
            >
              {avatar(comment.author.avatarUrl, comment.depth > 0 ? 24 : 32)}
              <div style={{ display: "flex", flexDirection: "column", flex: 1 }}>
